...
class AccountBankStatement(models.Model):
    ...
    def get_tax_move_lines(
            self, cr, uid, st_line, defaults, context=None):
        """
        ...
        return one or more serialized tax move lines and a set of values
        ...
        for tax in computed_taxes['taxes']:
            if tax['tax_code_id']:
                ...
                move_lines.append({
                    ...
                    'account_id': tax.get('account_collected_id',
                                          defaults['account_id']),
    ...
    @api.v7
    def _prepare_bank_move_line(self, cr, uid, st_line, move_id, amount,
